...
const quickSearches = ["HF4198-001", "DZ5485-400", "Jordan 4", "SB Dunk", "Travis Scott", "New Balance 990"];
const navItems = [
    ...
    <main className={`app-frame ${themeLabel === "Luxe" ? "luxe-mode" : ""} ${compactMode ? "compact-mode" : ""}`}>
      ...
      <section className="workspace">
        ...
        <section className="kpi-strip">
          ...
          <KpiCard icon={<ShieldCheck size={21} />} label="Last Checked" value={payload ? formatTime(payload.checkedAt) : "—"} note={payload?.cache.hit ? "Cached" : payload ? "Fresh check" : "Ready"} />
        </section>
        ...
        <section className="content-grid">
            ...
            {activeView !== "Search" && (
              <div className="view-card" ref={viewRef}>
                <div className="recent-title">
                  {activeView === "Favorites" && <Heart size={16} />}
                ...
                {activeView === "Settings" && (
                  <>
                  <div className="install-card"><Smartphone size={18} /><div><strong>Mobile App Mode</strong><span>Install this site to your home screen. Notification permission: {notificationPermission}.</span></div></div>
          ...
          <div className="detail-panel panel-shell">
            ...
            <div className="confidence-box">
              ...
              <p>{intelligence?.recommendation || selectedResult?.note || "Results use public product pages and visible stock indicators only."}</p>
            </div>
